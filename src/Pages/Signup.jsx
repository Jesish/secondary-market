...
function Signup() {
  return (
    <div className="flex min-h-screen">
      {/* Left Side */}
      <div className="w-1/2 hidden md:flex bg-[url('https://source.unsplash.com/800x800/?vintage,clothes')] bg-cover bg-center items-center justify-center text-white text-4xl font-bold p-10">
